...
public class ShowMap_No_Class {
    ...
    public void setMARKERS_CUSTOMER_ONLINE(List<Marker> MARKERS_CUSTOMER_ONLINE) {
            ...
            public void onKeyEntered(final String key,final GeoLocation location) {
                ...
                if (You_Have_Show_Customer_Online){
                    ...
                    if (key != null && !key.equals(F.Uid())) {
                        ...
                        F.Drivers().child(key).addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                        ...
                        if (key != null) {
                            for (Marker markerIt : MARKERS_CUSTOMER_ONLINE) {
                                if (markerIt.getTag() != null) {
                                    if (markerIt.getTag().equals(key)) {
                                        markerIt.remove();
                                        showMap_eventListener.onKeyExited(key,index);
                                    }else {
                                        index++;
                                    }
                                }
                                        ...
                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                            ...
                                            if (drivers!=null){
                                                ...
                                                if (drivers.getRotation()!=0.0){
                                                    ...
                                                    markerIt.setRotation(drivers.getRotation());
    ...
    public void SearchFromthisPoint(){
        ...
        GeoQuery_CUSTOMER_ONLINE.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(final String key,final GeoLocation location) {
                ...
                Log.d("onKeyEntered",key +" =====   OK_KEY_ENTER");
                ...
                if (You_Have_Show_Customer_Online){
                    ...
                    if (key != null && !key.equals(F.Uid())) {
                        ...
                        Log.d("onKeyEntered",key +" =====   ON_AFTER_LOOP");
                        ...
                        mDriverMarker = getMap().addMarker(new MarkerOptions().flat(isFlat()).position(driverLocation).title(TitleMarker).icon(BitmapDescriptorFactory.fromResource(getResourseMarkerDrawAbe())));
                        MARKERS_CUSTOMER_ONLINE.add(mDriverMarker);
                        DriverOnlineKey.add(key);
                        mDriverMarker.setTag(key);
