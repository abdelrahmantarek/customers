...
public class Sheet_sat7a_3ady_details implements AdapterView.OnItemSelectedListener{
    ...
    public Sheet_sat7a_3ady_details(final Activity activity, final GoogleMap map, Database database , List<Marker> MARKERS_CUSTOMER_ONLINE,ArrayList<String> user_is_requests, boolean driver_found) {
        ...
        spinner = activity.findViewById(R.id.spinner1);
        ...
        ((activity.findViewById(R.id.sat7a_call_the_driver))).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ((activity.findViewById(R.id.sat7a_image_edit_place_a_details))).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        ((activity.findViewById(R.id.sat7a_image_edit_place_b_details))).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    // system loop driver for request all

    // 1 - arrayList for Save ( Users allReady We Have send Request For him )
    // 2 - arrayList For All ( Driver Online )
    // 3 - When We Start Request Click send request // We Will Check if user if containt in ArraySave Or not
    // 4 - if after loop not have any key  we have else message
    // 5 - if after loop not have any key (and) we have arrayList (key) saved + we will remove all key from array save (and) startRequest
    // Again
    ...
    private void Make_new_Sheet() {
        ...
        sheet_sat7a_details = new BottomSheet((activity.findViewById(R.id.layout_sheet_sat7a_details)));
    ...
    private void findViewById() {
        ...
        progressBar_a = activity.findViewById(R.id.sat7a_progress_edit_place_a_details);
        progressBar_b = activity.findViewById(R.id.sat7a_progress_edit_place_b_details);
        edit_place_a = activity.findViewById(R.id.sat7a_edit_place_a_details);
        edit_place_b = activity.findViewById(R.id.sat7a_edit_place_b_details);
        sat7a_price = activity.findViewById(R.id.sat7a_the_price);
    }
